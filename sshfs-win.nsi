...
Section "MainSection" SEC01
  ...
  WriteRegStr HKLM "$LauncherRegistryKey\sshfs" "CommandLine" "svc %1 %2 -user %U -home %P -o ServerAliveInterval=30 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o idmap=user -o max_readahead=1GB -o large_read -o kernel_cache -o follow_symlinks -o create_dir_umask=007 -o create_file_umask=117 -o reconnect" 
  ...
  WriteRegStr HKLM "$LauncherRegistryKey\sshfs.r" "CommandLine" "svc %1 %2 -user %U -home %P -o ServerAliveInterval=30 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -o idmap=user -o max_readahead=1GB -o large_read -o kernel_cache -o follow_symlinks -o create_dir_umask=007 -o create_file_umask=117 -o reconnect"
